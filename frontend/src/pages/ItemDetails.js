...
const ItemDetails = () => {
  ...
  return (
    <div className="item-details1">
      ...
      {image && <img className="item-image1" src={`https://lostandfound-olab.onrender.com/${image}`} alt={title} />}
      ...
      {user ? (
        <div className='uploader-main'>         
          ...
          <div className='uploader-image'>
            <img className="uploader-profile-picture1" src={`https://lostandfound-olab.onrender.com/${user.profilePicture}`} alt={`${user.fname} ${user.lname}`} />
          </div>          
        </div>
      ) : (
